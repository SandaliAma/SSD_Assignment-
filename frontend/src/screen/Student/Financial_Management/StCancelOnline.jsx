    ...
    <div>
      ...
      <div className="bodycon">
            ...
            <h2 className="conh2"><br></br>Payment Details</h2><br/>
                    ...
                    <input type="text" name="itnum" placeholder="IT12345678" pattern="^IT\d{8}$"   required className="textcon1" value={itnumber}  /><br /><br />


                    <label htmlFor="totalA" className="labelcon1">Enter Description:</label><br />
                    <input type="text" name="description" placeholder="Class Name" pattern="[A-Za-z\s]+" required className="textcon7" value={discription} /><br /><br />

                    <label htmlFor="tda" className="labelcon2">Enter Date:</label><br />
                    <input type="date" name="date" placeholder="(DD/MM/YYYY)"  required className="textcon5" value={date} /><br /><br />

                    <label htmlFor="totalA" className="labelcon2">Enter Amount:</label><br />
                    <input type="text" name="amount" placeholder="00.00" pattern="\d+(\.\d{2})?" required className="textcon6"  value={amount} /><br /><br />
